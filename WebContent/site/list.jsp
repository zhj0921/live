...
<div class="bodywrapper">
                    ...
                    <thead>
                        <tr>
                          <th class="head0 nosort"><input type="checkbox" /></th>
                            ...
                            <th class="head1">站点名称</th>
                            <th class="head0">站点域名</th>
                    ...
                    <tfoot>
                        <tr>
                          <th class="head0"><span class="center">
                            ...
                            <th style="width: 80px;" class="head0">ID</th>
                            <th style="width: 120px;" class="head1">站点名称</th>
                            <th style="width: 120px;" class="head0">站点域名</th>
                            <th style="width: 120px;" class="head1">所属企业</th>
                   ...
                   <c:forEach items="${list}" var="list">
                        ...
                        <tr class="gradeX">
                          <td align="center"><span class="center">
                            ...
                            <td class="center">${list.enterprise}</td>
    ...
    <script type="text/javascript">
		...
		function del(iid) {
			...
			$.get("${pageContext.request.contextPath}/site/del.do", {
				id : iid
			}, function(res) {
				if ("ok" == res) {
					alert("删除成功！！");
					location.href="${pageContext.request.contextPath}/site/list.do";
				} else {
					alert("删除失败,请与管理员联系！！");
					location.href="${pageContext.request.contextPath}/site/list.do";
				};
		...
		function enabled(iid) {
			...
			$.get( "${pageContext.request.contextPath}/site/isstatus.do",
				 { id : iid },
				function(res) {
					if ("ok" == res) {
						alert("启用成功！！");
		...
		function disable(iid) {
			...
			$.get("${pageContext.request.contextPath}/site/nostatus.do",
				{id : iid},
				function(res) {
					if ("ok" == res) {
						alert("禁用成功！！");
	...
	<script type="text/javascript">
		function update(id){
			var url = "${pageContext.request.contextPath}/site/editSite.do?id=" + id;
	...
	<script type="text/javascript">
		function add(){
		 	var url = "${pageContext.request.contextPath}/site/addSite.do";
		 	window.location.href= url;
		}
