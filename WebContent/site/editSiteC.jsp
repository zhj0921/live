...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper elements">
                    ...
                    <form class="stdform stdform2" action="${pagecontext.request.contextPath}/site/updateSiteC.do">
                    	<input id="id" type="hidden" value="${siteConfiguration.id}" name="id">
                    	<p>
                        	<label>站点标题</label>
                            <span class="field">
                            	<input type="text" value="${siteConfiguration.title}" name="title" class="width500" id="colorpicker2" />
                            </span><!--field-->
                        </p>
                        <p>
                        	<label>关键词</label>
                            <span class="field">
                            	<input type="text" value="${siteConfiguration.key_word}" name="key_word" class="width500" id="colorpicker2" />
                        ...
                        <p class="flatmode">
                        	<label>描述</label>
                            <span class="field">
                            	<input type="text" value="${siteConfiguration.describe}" name="describe" class="width500" id="colorpicker3" />
                               <!--  <br /><br />
	...
	<script type="text/javascript">
		function remove(){
		 	var url = "${pageContext.request.contextPath}/site/slist.do";
