...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper elements">
                    ...
                    <form class="stdform stdform2" action="${pagecontext.request.contextPath}/site/insertSiteConfiguration.do">
                    	
                    	<p>
                        	<label>站点标题</label>
                            <span class="field">
                            	<input type="text" name="title" class="width500" id="colorpicker2" />
                            </span><!--field-->
                        </p>
                        <p>
                        	<label>关键词</label>
                            <span class="field">
                            	<input type="text" name="key_word" class="width500" id="colorpicker2" />
                        ...
                        <p class="flatmode">
                        	<label>描述</label>
                            <span class="field">
                            	<input type="text" name="describe" class="width500" id="colorpicker3" />
                               <!--  <br /><br />
