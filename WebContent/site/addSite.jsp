...
<div class="bodywrapper">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">添加站点基本配置</h1>
        ...
        <div id="contentwrapper" class="contentwrapper elements">
                    ...
                    <form class="stdform stdform2" action="${pagecontext.request.contextPath}/site/insertSite.do">
                    	
                    	<p>
                        	<label>站点名称</label>
                            <span class="field">
                            	<input type="text" name="name" class="width500" id="colorpicker2" />
                            </span><!--field-->
                        </p>
                        <p>
                        	<label>站点域名</label>
                            <span class="field">
                            	<input type="text" name="domain_name" class="width500" id="colorpicker2" />
                        ...
                        <p class="flatmode">
                        	<label>所属企业</label>
                            <span class="field">
                            	<input type="text" name="enterprise" class="width500" id="colorpicker3" />
                               <!--  <br /><br />
