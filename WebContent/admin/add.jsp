	...
	<div class="wrapper wrapper-content animated fadeInRight">
		<div class="row">
			<div class="col-lg-12">
				...
				<header class="panel-heading"> 增加管理员 </header>
				<div class="panel-body">
					<form class="form-horizontal adminex-form registerform"
						method="post"
						action="${pageContext.request.contextPath}/admin/save.do"
						onSubmit="return ">
						<div class="panel-body">
									...
									<table
										...
										<tr>
											...
											<td style="width: 505px;"><input type="text"
												...
												datatype="*4-18" errormsg="请输入登录帐号4-8位" class="form-control"
												name="name"></td>
										</tr>
										<tr>
											...
											<td style="width: 505px;"><input type="password"
												...
												errormsg="请输入登录密码任意字符6-16位" name="password"></td>
										</tr>
										<tr>
											...
											<td style="width: 505px;"><input type="text"
												...
												nullmsg="请设置管理员电话！" errormsg="填写管理员电话不合法！！" name="telphone"></td>
										</tr>
										<tr>
											<td class="need" style="width: 290px;">管理员名称</td>
											<td style="width: 505px;"><input type="text"
												datatype="*2-8" errormsg="请输入管理员名称 任意字符2-8位"
												nullmsg="请设置管理员名称！" class="form-control" name="adminname"></td>
										</tr>
										<tr>
