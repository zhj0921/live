...
<div class="bodywrapper">
    ...
    <div class="header">
    	<ul class="headermenu">
            ...
            <li class="current"><a href="${pageContext.request.contextPath}/homepage/findData.do?classify=2"><span class="icon icon-message"></span>用户管理</a></li>
            <li><a href="${pageContext.request.contextPath}/homepage/findData.do?classify=3"><span class="icon icon-chart"></span>直播间管理</a></li>
        </ul>
