		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a href="#home" data-toggle="tab">增加反馈类型</a></li>
				</ul>
				</header>
				<form id="jvForm" class="form-horizontal adminex-form registerform" enctype="multipart/form-data"
					action="${pageContext.request.contextPath}/feedback/add.do"
					method="post" >
							...
							<div class="tab-pane active" id="home">
								<table class="display table table-bordered table-striped dataTable">
									<tr>
										...
										<input type="text" value="" name="name" class="form-control" datatype="*" nullmsg="请设置反馈类型！"  errormsg="输入的反馈类型不合法！" /></td>
									</tr>
								</table>
							</div>
						</div>
